    ...
    <div className="mx-auto max-w-4xl px-6 py-16 md:py-24">
      ...
      <FadeIn>
        ...
        <p className="mt-4 max-w-2xl text-lg leading-relaxed text-muted-foreground">
          I&apos;m a Computer Engineer and Frontend Developer currently working
          at Kathmandu Metropolitan City. I&apos;m passionate about creating
          intuitive and performant web experiences, specializing in modern React
          ecosystem tools — Next.js, TypeScript, and Tailwind CSS — and love
